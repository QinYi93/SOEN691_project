...
itemRatings = itemRatings.sort(['userId', 'ratings'], ascending=False).select('userId', 'movieId', 'ratings').show(200)
...
userRatings = userRatings.sort(['userId', 'ratings'], ascending=False).select('userId', 'movieId', 'ratings').show(200)
